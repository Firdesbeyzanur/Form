              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="password" v-model.lazy.trim="userData.password" >
                  </div>
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12 from-group">
                  ...
                  <select v-model="userData.selectedCity" class="form-control">
                    <option :selected="city == 'Ankara'" v-for="city in userData.cities" :key="city"> {{ city }} </option>
                  </select>
                </div>
              </div>
              <div class="row">
    ...
    data(){
      return {
        userData: {
          ...
          interest: [],
          gender: "",
          cities: ["İstanbul", "Ankara", "İzmir", "Erzincan", "Ordu", "Eskişehir", "Balıkesir", "Kütahya", "Adıyaman"],
          selectedCity: "",
        },
        switched: true,
        isSubmited: false
